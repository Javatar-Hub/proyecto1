...
public class Juez {
  ...
  public Juez(Long id, String nombre, String paterno, String materno, String usuario, int edad,
      String password, String foto, String disciplina) {
    super();
    this.id = id;
    this.nombre = nombre;
  ...
  public Juez(String nombre, String paterno, String materno, String usuario, int edad,
      String password, String foto, String disciplina) {
    super();
    this.nombre = nombre;
    this.paterno = paterno;
